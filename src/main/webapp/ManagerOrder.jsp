                                        ...
                                        <c:choose>
                                            ...
                                            <c:when test="${o.status == 4}">
                                                <span class="badge bg-danger"
                                                      ...
                                                      data-toggle="tooltip"
                                                      data-placement="top"
                                                      title="${fn:escapeXml(o.cancelReason != null && !o.cancelReason.isEmpty() ? o.cancelReason : 'No reason provided')}">
                                                    Cancel
                                                </span>
                                            </c:when>
                                        ...
                                        <td style="text-align: center">
                                            <c:choose>
                                                ...
                                                <c:when test="${o.status == 2}">
                                                    ...
                                                    <button class="btn btn-danger update-status" data-order-id="${o.id}" data-status="5">Fail</button> <!-- Thêm nút 'Fail' -->
                                                </c:when>
                                            </c:choose>
                                        </td>
