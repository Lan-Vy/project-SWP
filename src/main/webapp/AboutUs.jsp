                ...
                <div >
                        ...
                        <div class="column">
                            <div class="card">
                                <div class="container">
                                    ...
                                    <p class="title">CE180892</p>
                                    <p>Manager</p>
                                    <p>Thattmce180892@fpt.edu.vn</p>
                    ...
                    <div class="row">
                        <div class="column">
                            <div class="card">
                                <div class="container">
                                    ...
                                    <p class="title">CE180675</p>
                                    <p>Manager</p>
                                    <p>TrieuNTCE180675@fpt.edu.vn</p>
                                    <!--<p><button class="button">Contact</button></p>-->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="column">
                            <div class="card">
                                <div class="container">
                                    <h2>Thai Hoang Gia Phu</h2>
                                    <p class="title">CE182003</p>
                                    <p>Manager</p>
                                    <p>PhuTHG182004@fpt.edu.vn</p>
                                    <!--<p><button class="button">Contact</button></p>-->
                                </div>
                            </div>
                        </div>
