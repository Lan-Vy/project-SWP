...
public class Product {
    ...
    //    cái này dùng cho searchWithPaging của admin 
        public Product(int id, String name, String image, String title, String description, int cateID, List<SubImage> subImage, int isDeleted) {
        this.id = id;
        this.name = name;
        this.image = image;
//        this.price = price;
...
////    c
//        public Product(int id, String name, String image, double price, String title, String description, int cateID, List<SubImage> subImage, int amount) {
//        this.id = id;
//        this.name = name;
//        this.image = image;
//        this.price = price;
...
//    }
        ...
        public Product(int id, String name, String image, double price, String title, String description, int cateID, List<SubImage> subImage, Size size) {
        this.id = id;
        this.name = name;
        this.image = image;
        this.price = price;
    ...
    //cái này sài chung có view product all bên admin
    ...
    public Product(int id, double price, int isDeleted, int amount, Size size) {
        this.id = id;
        this.price = price;
        this.isDeleted = isDeleted;
        this.amount = amount;
